...
<nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top">
  <div class="container">
    ...
    <form action="/DoAn/pages/timkiem.php">
  <div class="search">
...
$select = "SELECT sanpham.ID,sanpham.TenSanPham , sanpham.MoTa,sanpham.MoTa,sanpham.Gia,sanpham.TonKho,sanpham.HinhAnh,loaisanpham.tenloaisanpham FROM sanpham, loaisanpham where sanpham.loaisanpham=loaisanpham.id AND sanpham.trangthai='1' ";
...
?>
<!-- thẻ hiển thị  tất cả sản phẩm trong sql -->
<div class="container">
    <p class="lead">Tất Cả Sản Phẩm  </p>
  </div>
  ...
  <div class="loginbox">
                            <a href="../pages/chitietsanpham.php?page_layout=chitiet&ID=<?php echo $row['ID'] ?>" method="POST" class="row img">
                                <img src="../uploads/<?php echo $row['HinhAnh']?>" alt=""width="300px" height="200px">
                            </a>
